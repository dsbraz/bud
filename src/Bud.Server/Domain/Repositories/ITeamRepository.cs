...
public interface ITeamRepository
{
    ...
    Task<Bud.Shared.Contracts.PagedResult<Team>> GetAllAsync(Guid? workspaceId, Guid? parentTeamId, string? search, int page, int pageSize, CancellationToken ct = default);
    Task<Bud.Shared.Contracts.PagedResult<Team>> GetSubTeamsAsync(Guid teamId, int page, int pageSize, CancellationToken ct = default);
    Task<Bud.Shared.Contracts.PagedResult<Collaborator>> GetCollaboratorsAsync(Guid teamId, int page, int pageSize, CancellationToken ct = default);
