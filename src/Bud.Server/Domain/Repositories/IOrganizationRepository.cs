...
public interface IOrganizationRepository
{
    ...
    Task<Bud.Shared.Contracts.PagedResult<Organization>> GetAllAsync(string? search, int page, int pageSize, CancellationToken ct = default);
    Task<Bud.Shared.Contracts.PagedResult<Workspace>> GetWorkspacesAsync(Guid organizationId, int page, int pageSize, CancellationToken ct = default);
    Task<Bud.Shared.Contracts.PagedResult<Collaborator>> GetCollaboratorsAsync(Guid organizationId, int page, int pageSize, CancellationToken ct = default);
