...
public sealed class MissionMetricCommandTests
{
    ...
    public async Task CreateAsync_WhenMissionNotFound_ReturnsNotFound()
    {
        ...
        var missionMetricCommand = new MissionMetricCommand(metricRepository.Object, authorizationGateway.Object);
        ...
        var result = await missionMetricCommand.CreateAsync(User, request);
    ...
    public async Task UpdateAsync_WhenUnauthorized_ReturnsForbidden()
    {
        ...
        var result = await missionMetricCommand.UpdateAsync(User, metric.Id, request);
    ...
    public async Task UpdateAsync_WhenAuthorized_UpdatesMetricViaRepository()
    {
        ...
        var result = await missionMetricCommand.UpdateAsync(User, metricId, request);
    ...
    public async Task DeleteAsync_WhenAuthorized_DelegatesToRepository()
    {
        ...
        var result = await missionMetricCommand.DeleteAsync(User, metric.Id);
    ...
    public async Task DeleteAsync_WhenMetricNotFound_ReturnsNotFound()
    {
        ...
        var result = await missionMetricCommand.DeleteAsync(User, Guid.NewGuid());
