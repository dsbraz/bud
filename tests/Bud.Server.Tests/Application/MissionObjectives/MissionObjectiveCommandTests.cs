...
public sealed class MissionObjectiveCommandTests
{
    ...
    private MissionObjectiveCommand CreateCommand()
    ...
    public async Task CreateAsync_WhenMissionNotFound_ReturnsNotFound()
    {
        ...
        var missionObjectiveCommand = CreateCommand();
        ...
        var result = await missionObjectiveCommand.CreateAsync(User, request);
    ...
    public async Task UpdateAsync_WhenObjectiveNotFound_ReturnsNotFound()
    {
        ...
        var result = await missionObjectiveCommand.UpdateAsync(User, Guid.NewGuid(), new UpdateMissionObjectiveRequest { Name = "X" });
    ...
    public async Task UpdateAsync_WhenUnauthorized_ReturnsForbidden()
    {
        ...
        var result = await missionObjectiveCommand.UpdateAsync(User, objective.Id, new UpdateMissionObjectiveRequest { Name = "X" });
    ...
    public async Task UpdateAsync_WhenAuthorized_UpdatesObjective()
    {
        ...
        var result = await missionObjectiveCommand.UpdateAsync(User, objective.Id, new UpdateMissionObjectiveRequest
        {
            Name = "Atualizado",
    ...
    public async Task DeleteAsync_WhenObjectiveNotFound_ReturnsNotFound()
    {
        ...
        var result = await missionObjectiveCommand.DeleteAsync(User, Guid.NewGuid());
    ...
    public async Task DeleteAsync_WhenUnauthorized_ReturnsForbidden()
    {
        ...
        var result = await missionObjectiveCommand.DeleteAsync(User, objective.Id);
