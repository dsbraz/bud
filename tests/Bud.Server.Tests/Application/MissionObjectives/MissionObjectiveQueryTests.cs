...
public sealed class MissionObjectiveQueryTests
{
    ...
    private MissionObjectiveQuery CreateQuery()
    ...
    public async Task GetByIdAsync_WhenFound_ReturnsObjective()
    {
        ...
        var missionObjectiveQuery = CreateQuery();

        var result = await missionObjectiveQuery.GetByIdAsync(objectiveId);
    ...
    public async Task GetByIdAsync_WhenNotFound_ReturnsNotFound()
    {
        ...
        var result = await missionObjectiveQuery.GetByIdAsync(Guid.NewGuid());
    ...
    public async Task GetByMissionAsync_ReturnsPagedResult()
    {
        ...
        var result = await missionObjectiveQuery.GetByMissionAsync(missionId, 1, 10);
    ...
    public async Task GetProgressAsync_DelegatesToProgressService()
    {
        ...
        var result = await missionObjectiveQuery.GetProgressAsync(ids);
