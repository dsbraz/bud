...
public sealed class ObjectiveDimensionCommandTests
{
    ...
    private ObjectiveDimensionCommand CreateCommand()
    ...
    public async Task CreateAsync_WithValidRequest_ReturnsSuccess()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.CreateAsync(User, new CreateObjectiveDimensionRequest { Name = "Clientes" });
    ...
    public async Task UpdateAsync_WhenNotFound_ReturnsNotFound()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.UpdateAsync(User, Guid.NewGuid(), new UpdateObjectiveDimensionRequest { Name = "Novo" });
    ...
    public async Task UpdateAsync_WhenUnauthorized_ReturnsForbidden()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.UpdateAsync(User, dimension.Id, new UpdateObjectiveDimensionRequest { Name = "Novo" });
    ...
    public async Task UpdateAsync_WhenDuplicateName_ReturnsConflict()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.UpdateAsync(User, dimension.Id, new UpdateObjectiveDimensionRequest { Name = "Processos" });
    ...
    public async Task DeleteAsync_WhenNotFound_ReturnsNotFound()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.DeleteAsync(User, Guid.NewGuid());
    ...
    public async Task DeleteAsync_WhenUnauthorized_ReturnsForbidden()
    {
        ...
        var objectiveDimensionCommand = CreateCommand();
        var result = await objectiveDimensionCommand.DeleteAsync(User, dimension.Id);
