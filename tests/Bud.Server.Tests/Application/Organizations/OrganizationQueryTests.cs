...
public sealed class OrganizationQueryTests
{
    ...
    public async Task GetByIdAsync_WithExistingOrganization_ReturnsSuccess()
    {
        ...
        var organizationQuery = new OrganizationQuery(_orgRepo.Object);

        // Act
        var result = await organizationQuery.GetByIdAsync(orgId);
    ...
    public async Task GetByIdAsync_WithNonExistingId_ReturnsNotFound()
    {
        ...
        // Act
        var result = await organizationQuery.GetByIdAsync(Guid.NewGuid());
    ...
    public async Task GetAllAsync_DelegatesToRepository()
    {
        ...
        // Act
        var result = await organizationQuery.GetAllAsync("bud", 1, 10);
    ...
    public async Task GetWorkspacesAsync_WithNonExistingOrganization_ReturnsNotFound()
    {
        ...
        // Act
        var result = await organizationQuery.GetWorkspacesAsync(Guid.NewGuid(), 1, 10);
    ...
    public async Task GetCollaboratorsAsync_WithNonExistingOrganization_ReturnsNotFound()
    {
        ...
        // Act
        var result = await organizationQuery.GetCollaboratorsAsync(Guid.NewGuid(), 1, 10);
