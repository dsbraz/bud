...
public sealed class OrganizationCommandUseCaseTests
{
    ...
    private OrganizationCommandUseCase CreateUseCase(string protectedOrgName = "getbud.co")
    {
        ...
        return new OrganizationCommandUseCase(_orgRepo.Object, _collabRepo.Object, settings);
    }
    ...
    public async Task UpdateAsync_WithNonExistentOrganization_ReturnsNotFound()
    {
        ...
        // Act
        var result = await useCase.UpdateAsync(Guid.NewGuid(), new UpdateOrganizationRequest { Name = "New Name" });
    ...
    public async Task UpdateAsync_ProtectedOrganization_ReturnsValidationError()
    {
        ...
        var useCase = CreateUseCase("getbud.co");

        // Act
        var result = await useCase.UpdateAsync(orgId, new UpdateOrganizationRequest { Name = "New Name" });
    ...
    public async Task UpdateAsync_WithNonExistentOwner_ReturnsNotFound()
    {
        ...
        // Act
        var result = await useCase.UpdateAsync(orgId, new UpdateOrganizationRequest { Name = "New Name", OwnerId = Guid.NewGuid() });
    ...
    public async Task UpdateAsync_WithOwnerNotLeader_ReturnsValidationError()
    {
        ...
        // Act
        var result = await useCase.UpdateAsync(orgId, new UpdateOrganizationRequest { Name = "New Name", OwnerId = nonLeaderId });
    ...
    public async Task DeleteAsync_WithNonExistentOrganization_ReturnsNotFound()
    {
        ...
        // Act
        var result = await useCase.DeleteAsync(Guid.NewGuid());
    ...
    public async Task DeleteAsync_ProtectedOrganization_ReturnsValidationError()
    {
        ...
        // Act
        var result = await useCase.DeleteAsync(orgId);
