...
public sealed class CollaboratorQueryTests
{
    ...
    public async Task GetByIdAsync_WithExistingCollaborator_ReturnsSuccess()
    {
        ...
        var collaboratorQuery = new CollaboratorQuery(_collabRepo.Object);

        var result = await collaboratorQuery.GetByIdAsync(collaboratorId);
    ...
    public async Task GetByIdAsync_WithNonExistingId_ReturnsNotFound()
    {
        ...
        var result = await collaboratorQuery.GetByIdAsync(Guid.NewGuid());
    ...
    public async Task GetLeadersAsync_ReturnsSuccess()
    {
        ...
        var result = await collaboratorQuery.GetLeadersAsync(organizationId);
    ...
    public async Task GetAvailableTeamsAsync_WithExistingCollaborator_ReturnsSuccess()
    {
        ...
        var result = await collaboratorQuery.GetAvailableTeamsAsync(collaboratorId, "produto");
    ...
    public async Task GetSubordinatesAsync_WithNonExistingCollaborator_ReturnsNotFound()
    {
        ...
        var result = await collaboratorQuery.GetSubordinatesAsync(Guid.NewGuid());
