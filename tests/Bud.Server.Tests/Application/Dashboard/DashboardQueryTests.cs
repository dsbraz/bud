...
public sealed class DashboardQueryTests
{
    ...
    public async Task GetMyDashboardAsync_WithoutCollaboratorInContext_ReturnsForbidden()
    {
        ...
        var dashboardQuery = new DashboardQuery(repository.Object, tenantProvider.Object);
        var user = new ClaimsPrincipal(new ClaimsIdentity());

        var result = await dashboardQuery.GetMyDashboardAsync(user);
    ...
    public async Task GetMyDashboardAsync_WithTeamId_PassesTeamIdToRepository()
    {
        ...
        var result = await dashboardQuery.GetMyDashboardAsync(user, teamId);
