...
public sealed class MetricCheckinCommandTests
{
    ...
    public async Task CreateAsync_WhenCollaboratorNotIdentified_ReturnsForbidden()
    {
        ...
        var notificationOrchestrator = CreateNotificationOrchestratorMock();
        var metricCheckinCommand = new MetricCheckinCommand(
        ...
        var result = await metricCheckinCommand.CreateAsync(User, request);
    ...
    public async Task UpdateAsync_WhenNotAuthorAndNotGlobalAdmin_ReturnsForbidden()
    {
        ...
        var result = await metricCheckinCommand.UpdateAsync(User, checkin.Id, request);
    ...
    public async Task DeleteAsync_WhenGlobalAdmin_RemovesViaRepository()
    {
        ...
        var result = await metricCheckinCommand.DeleteAsync(User, checkin.Id);
