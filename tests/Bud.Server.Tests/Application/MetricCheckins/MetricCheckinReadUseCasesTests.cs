...
public sealed class MetricCheckinReadUseCasesTests
{
    ...
    public async Task GetByIdAsync_WhenFound_ReturnsSuccess()
    {
        ...
        var useCase = new ViewMetricCheckinDetails(checkinRepository.Object);

        // Act
        var result = await useCase.ExecuteAsync(checkinId);
    ...
    public async Task GetAllAsync_DelegatesToRepository()
    {
        ...
        var useCase = new ListMetricCheckinHistory(checkinRepository.Object);
