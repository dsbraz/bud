...
public sealed class MetricCheckinQueryTests
{
    [Fact]
    public async Task GetByIdAsync_WhenFound_ReturnsSuccess()
    {
        ...
        var metricCheckinQuery = new MetricCheckinQuery(checkinRepository.Object);

        // Act
        var result = await metricCheckinQuery.GetByIdAsync(checkinId);
    ...
    public async Task GetAllAsync_DelegatesToRepository()
    {
        ...
        // Act
        var result = await metricCheckinQuery.GetAllAsync(null, null, 1, 10);
