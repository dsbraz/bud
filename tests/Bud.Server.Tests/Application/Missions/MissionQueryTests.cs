...
public sealed class MissionQueryTests
{
    ...
    private MissionQuery CreateQuery()
    ...
    public async Task GetByIdAsync_WithExistingMission_ReturnsSuccess()
    {
        ...
        var missionQuery = CreateQuery();

        var result = await missionQuery.GetByIdAsync(missionId);
    ...
    public async Task GetByIdAsync_WithNonExistingId_ReturnsNotFound()
    {
        ...
        var result = await missionQuery.GetByIdAsync(Guid.NewGuid());
    ...
    public async Task GetProgressAsync_DelegatesToProgressService()
    {
        ...
        var result = await missionQuery.GetProgressAsync(ids);
    ...
    public async Task GetMyMissionsAsync_WithNonExistingCollaborator_ReturnsNotFound()
    {
        ...
        var result = await missionQuery.GetMyMissionsAsync(Guid.NewGuid(), null, 1, 10);
    ...
    public async Task GetMetricsAsync_WhenMissionNotFound_ReturnsNotFound()
    {
        ...
        var result = await missionQuery.GetMetricsAsync(Guid.NewGuid(), 1, 10);
